...
writeFileLine: "/Users/hannahrowe/Desktop/Ratio_Data_For_R.csv", "Participant, Task, Time, F1, F2, Duration"
	...
	for thisInterval from 1 to numberOfPhonemes
		...
		if thisPhoneme$ != ""
			...
			for thisFrame from 1 to frameCount
				...
				appendFileLine: "/Users/hannahrowe/Desktop/Ratio_Data_For_R.csv", outputLine$
			endfor
		endif
	endfor
endfor