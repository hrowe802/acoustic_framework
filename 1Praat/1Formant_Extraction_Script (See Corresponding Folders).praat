...
writeFileLine: "/Users/hannahrowe/Desktop/Formant_Data_For_Matlab.csv", "Participant, Task, Time, F1, F2, Duration"
	...
	for thisInterval from 1 to numberOfPhonemes
		...
		if thisPhoneme$ != ""
			...
			for thisFrame from 1 to frameCount
				...
				appendFileLine: "/Users/hannahrowe/Desktop/Formant_Data_For_Matlab.csv", outputLine$
			endfor
		endif
	endfor
endfor
